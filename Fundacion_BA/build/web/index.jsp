<%-- 
    Document   : index
    Created on : 27/12/2021, 11:43:31 a. m.
    Author     : ZENBOOK
--%>
...
<html lang="en">
    ...
    <body class="main-layout">
                                ...
                                <div class="container">
                                    <div class="carousel-caption">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="text-bg" >
                                                    <span style="font-weight: 700">Fundación</span>
                                                    <h1>Bello Animal</h1>
                                                    <br><br>
                                                    <p style="font-size:24px;font-weight: 700">Recuerda que adoptar es cuidar y proteger una vida, esto implica tiempo y atención.</p>
                                                    <br><br><br>
                                                    <a href="Galeria.jsp" style="font-size:18px;font-weight: 700">Adopta un peludo</a> <a href="donaciones.jsp" style="font-size:18px;font-weight: 700">Has una donación</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="carousel-item">
                                <div class="container ">
                                    <div class="carousel-caption">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="text-bg" style=" background:url(../images/perro.jpg)">
                                                    <span style="font-weight: 700">Fundación</span>
                                                    <h1>Bello Animal</h1>
                                                    <br><br>
                                                    <p style="font-size:24px;font-weight: 700">Hay un ser lleno de amor y alegría esperando por ti</p>
                                                    <br><br><br>
                                                    <a href="Galeria.jsp"style="font-size:18px;font-weight: 700">Adopta un peludo</a><a href="donaciones.jsp" style="font-size:18px;font-weight: 700">Has una donación</a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="text-bg">
                                                    ...
                                                    <h1>Bello Animal</h1>
                                                    <br><br>
                                                    <p style="font-size:24px;font-weight: 700">Para que comprar si hay tantos animales que necesitan un hogar</p>
                                                    <br><br><br>
                                                    <a href="Galeria.jsp" style="font-size:18px;font-weight: 700">Adopta un peludo</a><a href="donaciones.jsp" style="font-size:18px;font-weight: 700">Has una donación</a>
                                                </div>
                                            </div>
        ...
        <!-- about  -->
        <div id="about fondo1" class="about">
            <div class="container">
                <div class="row display_boxflex">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="about-box">
                            <h2 style="font-weight: 700">¿Quiénes somos?</h2>
                            <p style="font-weight: 450">Somos una fundación sin ánimo de lucro, que busca una familia a seres extraordinarios llenos de amor y alegría.
                                Nuestro propósito es mejorar la vida de los animales que están en situación de maltrato y/o abandono, dándoles un lugar importante, caluroso y lleno de esperanza en nuestra sociedad.
                            </p>  
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                ...
                <div class="row display_boxflex">
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 margi_bott">
                                <div class="Gallery_img">
                                    <figure><img src="images/Animal1.jpg" alt="#"/></figure>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 margi_bott">
                                <div class="Gallery_img">
                                    <figure><img src="images/Animal2.jpg" alt="#"/></figure>
                                </div>

                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 margi_bott1">
                                <div class="Gallery_img">
                                    <figure><img src="images/Animal3.jpeg" alt="#"/></figure>
                                </div>

                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <div class="Gallery_img">
                                    <figure><img src="images/Animal4.jpeg" alt="#"/></figure>
                                </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                        <div class="Gallery_text">
                            <div class="titlepage">
                                <h2 style="font-weight: 700">¡Adopta!</h2>
                            </div>
                            <p style="font-weight: 450">Estos maravillosos seres están buscando una familia o persona que necesite de amor, acompañamiento y ternura.</p>
                            <a href="Galeria.jsp" style="font-size:18px;font-weight: 700">Conoce más</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="upcoming" class="upcoming">
            <div class="container">
                <div class="row display_boxflex">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="upcoming-box Gallery_text">
                            <h2 style="font-weight: 700">Dona o apadrina</h2>
                            <p style="font-weight: 450">Si quieres hacer una donación voluntaria, ya sea económica o de algunos elementos para la fundación, sería de gran utilidad para el sostenimiento de nuestros hogares de paso.   
                                Adicionalmente, contamos con el Plan Padrino, el cual consiste en hacer un acompañamiento de su ahijado(a), dándole una cuota mensual, mediante la cual le garantizamos la alimentación y atenciones veterinarias.
                            </p>  
                            <a href="donaciones.jsp" style="font-size:18px;font-weight: 700">Has tu donación</a>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="about-box">
                            <figure><img src="images/FBA1.png" alt="#" /></figure>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script>
            window.addEventListener("scroll", function () {
                ...
                header.classList.toggle("scrollIndex", window.scrollY > 800);
                header.classList.toggle("pt-3", window.scrollY > 800);
                header.classList.toggle("pb-3", window.scrollY > 800);
            });
        </script>
        ...
        <!-- Chatbot -->
        <script src="https://account.snatchbot.me/script.js"></script><script>window.sntchChat.Init(231017);</script>         <script src="js/custom.js"></script>
