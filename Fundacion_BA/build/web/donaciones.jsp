                                ...
                                <div class="limit-box">
                                    <nav class="main-menu ">
                                        <ul class="menu-area-main">
                                            ...
                                            <li class="active"> <a href="donaciones.jsp">Donar </a> </li>
        ...
        <div class="backgro_mh">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="heding">
                            <h2 style="font-weight: 700">Donaciones</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row display_boxflex">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="about-box">
                            <h1 class="color-azul font-weight-bold" style="font-size: 32px">Escanea el código QR para donar</h1>
                            <p style="font-weight: 600;font-size: 19px">Un granito de arena puede parecer pequeño e insignificante, pero muchos granitos unidos pueden hacer una montaña gigante. Súmate y realiza tu aporte, por pequeño que parezca puede generar grandes impactos.
                                <br><br>
                                Un pequeño acto de generosidad engrandece el alma, alegra el corazón y colma de bienestar.Tu donación es la razón de ser de nuestra causa y la felicidad de nuestros amigos peludos y bigotones.
                                <br><br>
                                Gracias por contribuir, tu aporte es muy importante para el fortalecimiento y desarrollo de cada animal beneficiado. 
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="donar-box">
                            <center>
                                <figure><img src="./images/codigo_qr.png" alt="Codigo QR"/></figure>
                            </center>
                        </div>
                    </div>
                </div>
