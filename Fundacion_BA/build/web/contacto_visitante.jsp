        ...
        <footer>
            <div class="footer ">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <form class="contact_bg" id="form_contacto" onsubmit="formContacto(event)">
                                <div class="row">
                                    <div class="col-md-12">                                 
                                        <div class="col-md-12">
                                            <input class="contactus" placeholder="Nombre completo" type="text" name="nombre" required>
                                        </div>
                                        <div class="col-md-12">
                                            <input class="contactus" placeholder="Correo eléctronico" type="text" name="email" required>
                                        </div>
                                        <div class="col-md-12">
                                            <input class="contactus" placeholder="Celular" type="number" name="celular">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label for="sel1" class="text-white">Tipo de PQRS: </label>
                                            <select class="form-control" id="sel1" name="select_pqrs" autocomplete="off" required>
                                                <option value="" selected disable>-- Seleccionar tipo de PQRS --</option>
                                        ...
                                        <div class="col-md-12">
                                            <input class="contactus" placeholder="Asunto" type="text" name="asunto" required>
                                        </div>
                                        <div class="col-md-12">
                                            <textarea class="textarea" placeholder="Mensaje" type="text" name="mensaje" required></textarea>
                                        </div>
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            <button class="send" type="button" name="accion">Enviar</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 ">
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 ">
                                    <div class="address">
                                        <ul class="loca">
                                            <li><a href="https://www.google.com/maps/place/Fundaci%C3%B3n+Bello+Animal/@6.332093,-75.5654649,17z/data=!3m1!4b1!4m5!3m4!1s0x8e442fa7e293574d:0x69a84a5502e8ba26!8m2!3d6.3320935!4d-75.5631885"><i class="fa fa-map-marker" aria-hidden="true"></i>  Cra. 54b ##47-45, Bello, Antioquia</a></li>
                                            <li><a href="https://api.whatsapp.com/send?phone=573206400925"><i class="fa fa-phone" aria-hidden="true"></i>  +57 3206400925</a></li>
                                        </ul>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 ">
                                    <ul class="social_link">
                                        <li><a href="https://www.facebook.com/fundacionbelloanimal"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                        <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                                        <li><a href="https://www.instagram.com/fundacionbelloanimal/?hl=es-la"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
