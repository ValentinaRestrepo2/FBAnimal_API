<%-- 
    ...
    Created on : 23/01/2022, 15:48:36 p. m.
    Author     : Andres Marin
--%>
    ...
    <div class="fondo5">
        <div class="text-center">
            <div class="d-lg-flex d-md-flex justify-content-lg-center justify-content-md-center">
                <form method="POST" action="ControladorVisitante" class="pr-2">
                    <button type="submit" value="mascotas" name="visitante" class="backgro-transparente p-3">
                        <img src="images/gatito.png" width="120" height="120" alt="Usuarios" />
                    </button>
                    <h1 style="font-weight: 700;font-size: 20px">Mascotas <br> disponibles</h1>
                </form>
                <!--<a href="listar_mascotas.jsp"><img src="images/gatito.png" width="150" height="150" alt="Mascotas" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
                <form method="POST" action="ControladorVisitante" class="pr-2"> 
                    <button type="submit" value="donarVisitante" name="visitante" class="backgro-transparente p-3">
                        <img src="images/donar.png" width="120" height="120" alt="Adopciones" />
                    </button>
                    <h1 style="font-weight: 700;font-size: 20px">Donar</h1>
                </form>
                <form method="POST" action="ControladorVisitante" class="pr-2"> 
                    <button type="submit" value="adopcioneslist" name="visitante" class="backgro-transparente p-3">
                ...
                <form method="POST" action="ControladorVisitante" class="pr-2">
                    <button type="submit" value="contactoUsuario" name="visitante" class="backgro-transparente p-3">
                ...
                <form method="POST" action="ControladorVisitante" class="pr-2">
                    <button type="submit" value="anuncio" name="visitante" class="backgro-transparente p-3">
                        <img src="images/anuncio-emergente.png" width="120" height="120" alt="Anuncios" />
                    </button>
                    <h1 style="font-weight: 700;font-size: 20px">Anuncios<br> publicados</h1>
                </form>
                <form method="POST" action="ControladorVisitante" class="pr-2">
                    <button type="submit" value="informe" name="visitante" class="backgro-transparente p-3">
