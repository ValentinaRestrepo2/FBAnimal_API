<%-- 
    Document   : contra_visitante
    Created on : 25-ene-2022, 15:36:15
    Author     : Andrés Marín
--%>
                    ...
                    <form class="contact_bg" action="ControladorIniciosesion" method="POST">
                        ...
                        <div class="col-md-12">      
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
                                ...
                                <button type="submit" name="accion" value="ActualizarContra" class="sendlogin" style="font-size:18px;font-weight: 700">Actualizar</button>
                            </div>
                        </div>
                    </form>
                </div>
