<%-- 
    Document   : listarInformesAdmin
    Created on : 4/07/2022, 10:36:45 AM
    Author     : PC
--%>
        ...
        <div class="backgro_mh">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="heding">
                            <h2 style="font-weight: 700">Informes recibidos</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="fondo6">
            ...
            <div class="container d-flex flex-wrap gap-2 justify-content-center">
                <%
                    List<Informes> datos;
                    datos = null;
                    datos = informesDAO.listarInformesAdmin();
                    if (datos != null) {
                        for (Informes info : datos) {%>
                <div class="card border-info mb-3" style="max-width: 22rem;">
                    <div class="card-header" style="background-color: #13181C">
                        <span class="color-azul font-weight-bold" style="font-size: 22px">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-emoji-laughing-fill" viewBox="0 0 16 16">
                            ...
                            Informe de <%=info.getNombreMascota()%>
                        </span>
                    </div>
                    <div class="card-body text-info">
                        <h5 class="card-title" style="font-weight: 500;font-size: 17px"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-alarm" viewBox="0 0 16 16">
                            <path d="M8.5 5.5a.5.5 0 0 0-1 0v3.362l-1.429 2.38a.5.5 0 1 0 .858.515l1.5-2.5A.5.5 0 0 0 8.5 9V5.5z"/>
                            <path d="M6.5 0a.5.5 0 0 0 0 1H7v1.07a7.001 7.001 0 0 0-3.273 12.474l-.602.602a.5.5 0 0 0 .707.708l.746-.746A6.97 6.97 0 0 0 8 16a6.97 6.97 0 0 0 3.422-.892l.746.746a.5.5 0 0 0 .707-.708l-.601-.602A7.001 7.001 0 0 0 9 2.07V1h.5a.5.5 0 0 0 0-1h-3zm1.038 3.018a6.093 6.093 0 0 1 .924 0 6 6 0 1 1-.924 0zM0 3.5c0 .753.333 1.429.86 1.887A8.035 8.035 0 0 1 4.387 1.86 2.5 2.5 0 0 0 0 3.5zM13.5 1c-.753 0-1.429.333-1.887.86a8.035 8.035 0 0 1 3.527 3.527A2.5 2.5 0 0 0 13.5 1z"/>
                            </svg>&nbsp;&nbsp;
                            <i><%=info.getFecha_informe()%></i></h5>
                        <p class="card-text" style="font-weight: 500;font-size: 17px">
                            ...
                            <span class="font-weight-bold color-azul" style="font-weight: 500;font-size: 17px">Mensaje sobre la mascota: </span><span class="text-black-50"><%=info.getDescripcion_informe()%></span></p>
                        <br/>
                        <p class="card-text" class="card-text" style="font-weight: 500;font-size: 17px" >
                            ...
                            <span class="font-weight-bold color-azul" style="font-weight: 500;font-size: 17px">Adoptante: </span><span class="text-black-50"><%=info.getNombre()%></span></p>
                        <br/>
                        <div class="d-flex justify-content-center cursor-pointer">
                            <form method="POST" action="ControladorInformes"> 
                                <input type="hidden" id="id_informe" name="id_informe" value="<%=info.getId_informe()%>">
                                <button class="bg-transparent" type="submit" value="listarMensajeInformeXID" name="accion">
