<%-- 
    Document   : mensajesdeUsuarios
    Created on : 13/02/2022, 05:30:23 PM
    Author     : Andrés Marín
--%>
...
<html lang="en">
    ...
    <%String rspta = "";
        ...
        if (request.getParameter("rspta") != null) {
            ...
            if (r == 3051518) {
                rspta = "No se ha podido contactar a la administradora.";
                coloractivo = "font-weight-bold text-center text-danger";
                dnone = "d-block";
            } else {
                System.out.println(rspta + "loginn");
                rspta = "¡Felicidades, hemos enviado tu mensaje!";
    ...
    <div class="row Gallery fondo7">
        <div class="col-md-12 ">
            ...
            <br>
            <form class="contact_bg" id="formconusuario" onsubmit="formContacto(event)">
                <div class="row">
                    <div class="col-md-12">  
                        ...
                        <br>
                        <h1 class="font-weight-bold" style="margin-top: 20px;font-weight: 700;font-size: 24px;color:white">Déjanos tu mensaje y te responderemos en lo más pronto </h1>

                        <input class="contactus" value="<%=session.getAttribute("datosUser")%> <%=session.getAttribute("primerApellido")%> <%=session.getAttribute("segApellido")%>"type="hidden" name="nombre">
                        <input class="contactus"value="<%=session.getAttribute("email")%>" type="hidden" name="email">
                        <input class="contactus" value="<%=session.getAttribute("celular")%>" type="hidden" name="celular">
                        <center>
                            <div class="form-group col-md-12">
                                <select class="form-control" id="sel1" name="select_pqrs" autocomplete="off" required>
                                    <option value="1">-- Selecciona el tipo de PQRS --</option>
                                    <option value="2">Sugerencia</option>
                                    <option value="3">Reclamo</option>
                                    <option value="4">Pregunta</option>
                                    <option value="5">Quejas</option>
                                </select>
                            </div>
                        </center>
                        <div class="col-md-12">
                            <textarea class="textarea" placeholder="Mensaje *" autocomplete="off" type="text" name="mensaje" required></textarea>
                        </div>
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <button class="sendlogin" type="button" id="btnenviar" name="visitante"  style="font-size:18px;font-weight: 700" onclick="formusuario()">Enviar</button>
                        </div>
                    </div>
                </div>
            </form>
...
<script>
                                ...
                                document.getElementById("btnenviar").addEventListener("click", () => {
                                    ...
                                    if (select_pqrs === "1" || mensaje.trim() === "") {
                                        ...
                                        document.getElementById("btnenviar").value = "agregarContactoUsuario";
                                        formconusuario.method = "POST";
                                        formconusuario.action = "ControladorVisitante";
                                        document.getElementById("btnenviar").type = "submit";
                                        formconusuario.submit();
                                        console.log("holaa");
