<%-- 
    ...
    Created on : 27-ene-2022, 10:09:18
    Author     : Andrés Marín
--%>
            ...
            <div class="container p-3">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <button type="submit" class="btn btn-info m-2" style="font-size:18px;font-weight: 700"><a class="text-white" href="edit_perfil.jsp" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-pencil-square-o" aria-hidden="true">
                                </i>&nbsp;Editar información</a>
                        </button>
                        <form method="POST" action="ControladorUsuario" onsubmit="formRegistroUsuario(event)">
                            <button type="submit" value="cambiarcontra" name="accion" class="btn btn-dark m-2" style="font-size:18px;font-weight: 700">
                                <a class="d-flex align-items-center text-white"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp;
                                    Cambiar contraseña
                                </a>
                            </button>
                        </form>
                        <!-- comment
                         <form method="POST" action="ControladorIniciosesion" onsubmit="return eliminarCount()">
                             ...
                             <button type="submit" class="btn btn-danger m-2" name="accion" value="eliminarCountAdmin" style="font-size:18px;font-weight: 700"><i class="fa fa-trash-o" aria-hidden="true"></i>&nbsp; Eliminar cuenta</button> 
                         </form> -->
                            ...
                            <div class="modal-dialog modal-lg" role="document" >
                                <div class="modal-content" >
                                    ...
                                    <div class="modal-body">
                                        <form onsubmit="validarPerfil(event)" action="ControladorIniciosesion" method="POST" name="form_perfil">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <select name="select_civil" required class="form-control">
                                            ...
                                            <div class="form-group">
                                                <label for="message-text" class="col-form-label font-weight-bold" >Puesto de trabajo<span class="text-danger"> *</span> </label>
