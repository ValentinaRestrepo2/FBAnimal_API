...
<%-- 
    Document   : adopciones_visitante
    Created on : 25-ene-2022, 14:06:22
    Author     : Andrés Marín
--%>
...
<html lang="en">
    <head>
        ...
        <!-- site metas -->
        <title>Solicitud de Adopción | Fundación Bello Animal</title>
                    ...
                    <table class="tabla2  table table-responsive table-hover">
                        ...
                        <tbody>
                            <%
                                ...
                                datos = null;
                                datos = adopcion.listarMisSolicitudes(id);
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;" class="d-flex align-content-center justify-content-center align-items-center">
                                    <form action="ContoladorAdopciones" method="POST">
                                        ...
                                        <button class="btn btn-danger" type="submit" name="accion" value="cancelarSolicitud">
                        ...
                        <h4 class="font-weight-bold color-azul text-center pb-5" style="font-weight: 800;font-size: 20px">No haz realizado ninguna solicitud de adopción.</h4>
                        <%}%>
                        </tbody>
                    </table>
                </div>
