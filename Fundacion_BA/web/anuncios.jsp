                                ...
                                <div class="limit-box">
                                    <nav class="main-menu ">
                                        <ul class="menu-area-main">
                                            ...
                                            <li class="active"> <a href="anuncios.jsp">Anuncios</a> </li>
                    ...
                    <div class="row">
                        <div class="container-fluid bg-trasparent my-4 p-3" style="position: relative;">
                            <div class="row row-cols-1 row-cols-xs-2 row-cols-sm-2 row-cols-lg-4 g-3">
                                ...
                                <div class="col-md-4 mt-2">
                                    <div class="card h-100 shadow-sm"> <img src="${pageContext.servletContext.contextPath}/imganuncio?id=<%=anu.getId_anuncio()%>" class="img-anuncios" alt="imagen del anuncio: <%=anu.getNombre_anuncio()%>">
                                        <div class="card-body">
                                            ...
                                            <h5 class="card-title" style="font-weight: 500;font-size: 15px"><%=anu.getDescripcion()%></h5>
                                ...
                                <h3 class="font-weight-bold text-center pt-5">En este momento, no hay anuncios publicados</h3>
                                <%}
