    ...
    <div class="backgro_mh">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="heding">
                        <h2 style="font-weight: 700">Adoptar una mascota</h2>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 margi_bott">
                            <div class="Gallery_img">
                                <figure><img src="ControlerIMG?id=<%=m.getId()%>" class="img-30" alt="imagen del <%=m.getNombre()%>"/></figure>
                            </div>
                            <div class="hover_box">

                                <ul class="icon_hu">
                                    <p class=" m-auto text-center text-white"><span class="font-weight-bold">Nombre: </span><%=m.getNombre()%></p>
                                    <p class=" m-auto text-center text-white"><span class="font-weight-bold">Descripción: </span><%=m.getDescripcion()%></p>
                                    <p class=" m-auto text-center text-white"><span class="font-weight-bold">Raza: </span><%=m.getRaza()%></p>
                                    <p class=" m-auto text-center text-white"><span class="font-weight-bold">Genero: </span><%=m.getGenero_mascota()%></p>
                                    <p class=" m-auto text-center text-white"><span class="font-weight-bold">Edad: </span><%=m.getEdad()%> años</p>
                                    <% if (m.getVacunado() == 1) {%>
                                    <p class=" m-auto text-center text-white"><span class="font-weight-bold">Vacunado: </span>Sí</p>
                                    <%} else if (m.getVacunado() == 2) {%>
                                    <p class=" m-auto text-center text-white"><span class="font-weight-bold">Vacunado: </span>No</p>
                                    <%} else if (m.getVacunado() == 3) {%>
                                    <p class=" m-auto text-center text-white"><span class="font-weight-bold">Vacunado: </span>Pendiente</p>
                                    <%}%>

                                    <% if (m.getEsterilizado() == 1) {%>
                                    <p class="m-auto text-center text-white"><span class="font-weight-bold">Esterilizado: </span>Sí</p>
                                    <%} else if (m.getEsterilizado() == 2) {%>
                                    <p class=" m-auto text-center text-white"><span class="font-weight-bold">Esterilizado: </span>No</p>
                                    <%}%>

                                    <% if (m.getDisponibilidad() == 1) {%>
                                    <form method="POST" action="ControladorVisitante">
                                        <div class="contenedor__btn_adoptar">
                                            <input type="hidden" name="nameMascotaAdoptar" value="<%=m.getNombre()%>">
                                            <input type="hidden" name="idmascotaDoptar" value="<%=m.getId()%>">
                                            <button type="submit" name="visitante" class="btn__adoptar" value="AdoptarVisitante">
                                                Adoptar
                                            </button>
                                        </div>   
                                    </form>
                        ...
                        <%}%>
                        <%} else {%>
                        <h1>No tenemos mascotas disponibles.</h1>
                        <%}%>
                    </div>
                </div>
