...
<html lang="en">
    ...
    <head>
        ...
        <!-- site metas -->
        <title>Reportes | Fundación Bello Animal</title>
    ...
    <body class="main-layout contineer_page">
        ...
        <div class="backgro_mh">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="heding">
                            <h2 style="font-weight: 700">Reportes</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="fondo6">
            <div class="button-informe">
                <button class="generatePDF" id="generate_excel" title="Generar PDF"><img src="https://img.icons8.com/fluency/48/null/pdf.png" alt="Icon pdf"/></button>
                <button class="generatePDF" title="Generar Excel" id="generate_excel" onclick="generateExcelData()"><img src="https://img.icons8.com/color/48/null/microsoft-excel-2019--v1.png" alt="Icon excel"/></button>
            </div>
            <div id="impresion" style="margin-top: 0px">
                <div class="container">
                    <div class="col-xl-12">
                        <% String listarCantidaddeContactosSinResponder = estadisticaDAO.listarCantidaddeContactosSinResponder();%>
                        <% String daticos = estadisticaDAO.listarRazasXMascotas();%>
                        <% String listarAdoptadosYRazas = estadisticaDAO.listarAdoptadosYRazas();%>
                        <% String listarUsuariosxFechaRegistro = estadisticaDAO.listarUsuariosxFechaRegistro();%>
                        <% String listarMascotasInformacion = estadisticaDAO.listarMascotasInformacion();%>
                        <h1 type="hidden" id="daticos_informe" class="d-none">[<%=daticos%>{}]</h1>
                        <h1 type="hidden" id="listarMascotasInformacion" class="d-none"><%=listarMascotasInformacion%></h1>
                        <h1 type="hidden" id="daticos_informetq" class="d-none">[<%=listarAdoptadosYRazas%>{}]</h1>
                        <h1 type="hidden" id="listarUsuariosxFechaRegistro" class="d-none">[<%=listarUsuariosxFechaRegistro%>{}]</h1>
                        <h1 type="hidden" id="listarCantidaddeContactosSinResponder" class="d-none"><%=listarCantidaddeContactosSinResponder%></h1>
                        <div class="row">
                            <div class="col-md-12">
                                <div>
                                    <h2 class="subtitles" style="font-weight: 700">Mascotas adoptadas con sus adoptantes</h2>
                                    <p>Aquí encontraras la lista de mascotas adoptadas con la información de sus adoptantes.</p>
                                </div>
                            </div>
                        </div>
                        <table class="tabla2 table table-responsive table-hover" id="datos">
                            <thead>
                                <tr>
                                    ...
                                    <th  class="text-center color-azul font-weight-bold">NOMBRE MASCOTA</th>
                                    <th  class="text-center color-azul font-weight-bold">RAZA MASCOTA</th>
                                </tr>
                            </thead>
                            <tbody id="mascotasandrazas">
                            </tbody>
                        </table>
                        <hr/>
                        <div class="row">
                            <div class="col-md-12">
                                <div>
                                    <h2 class="subtitles" style="font-weight: 700">Usuarios y sus fechas de registro</h2>
                                    <p>Información con respeto a la fecha de registro de los usuarios, tanto la fecha como la hora.</p>
                                </div>
                            </div>
                        </div>
                        <table class="tabla2 table table-responsive table-hover" id="datos">
                            <thead>
                                <tr>
                                    ...
                                    <th  class="text-center color-azul font-weight-bold">FECHA DE REGISTRO</th>
                                </tr>
                            </thead>
                            <tbody id="usuariosxregistro">
                            </tbody>
                        </table>
                        <hr/>
                        <div class="row">
                            <div class="col-md-12">
                                <div>
                                    <h2 class="subtitles" style="font-weight: 700">Cantidad de mascotas por clasificaciones</h2>
                                    <p>Conocer la cantidad de mascotas que hay disponibles, adoptadas, fallecidas, no disponibles.</p>
                                </div>
                            </div>
                        </div>
                        <div class="graphs">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div>
                                    <h2 class="subtitles" style="font-weight: 700">Cantidad de mensajes/contatos recibidos sin contestar y contestados.</h2>
                                </div>
                            </div>
                        </div>
                        <div class="graphs">
                            <canvas id="chartContactos" width="400" height="400"></canvas>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script src="js/xlsx/generateFileExcel.js"></script>
        ...
        <script>
                document.addEventListener("DOMContentLoaded", () => {
                    const $boton = document.querySelector("#generate_excel").addEventListener("click", () => {
                        const $elementoParaConvertir = document.querySelector("#impresion"); // <-- Aquí puedes elegir cualquier elemento del DOM
                        const tiempoTranscurrido = Date.now();
                        const hoy = new Date(tiempoTranscurrido);
                        html2pdf()
                                .set({
                                    margin: 0,
                                    filename: `Reportes-${Date.now()}.pdf`,
                                    image: {
                                        type: 'pdf',
                                        quality: 0.98
                                    },
