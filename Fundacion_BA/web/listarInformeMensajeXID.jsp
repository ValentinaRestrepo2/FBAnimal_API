<%-- 
    Document   : listarInformeMensajeXID
    Created on : 4/07/2022, 11:36:10 AM
    Author     : PC
--%>
...
<%
    ...
    String id_informe = (String) request.getParameter("key");
...
<html lang="en">
    ...
    <%
        ...
        informes = informesDAO.informeCompletoporId(id_informe);
    %>
    <body class="main-layout contineer_page">
                    ...
                    <center>
                        <div class="input-group2">
                            <span class="input-group-text" id="basic-addon1" style="background:#23BFD8;align-content: center;border-color: #23BFD8">
                                ...
                                <h2 style="font-weight: 700;font-size: 40px;align-content: center">Informe de la mascota <span class="font-weight-bold text-dark"><%=informes.getNombreMascota()%></span> </h2>
                            </span>
                        </div>
                    </center>
                </div>
        ...
        <div class="fondo6">
            <div class="container" style="background-color: white;border-radius: 20px;padding: 50px 50px;border: 5px solid #23BFD8">
                <div class="row mt-3">
                    <div class="col-md-6">
                        <br/>
                        <i style="font-weight: 500;font-size: 22px"><span class="color-azul font-weight-bold" style="font-size: 27px">Fecha de envío: </span><%=informes.getFecha_informe()%></i>
                        <br/>
                        <br/>
                        <p style="font-weight: 500;font-size: 22px"> <span class="color-azul font-weight-bold" style="font-size: 27px"> Adoptante:</span> <%=informes.getNombre()%> <%=informes.getPrimer_apellido()%></p>
                        <br/>
                        <p style="font-weight: 500;font-size: 22px"><span class="color-azul font-weight-bold" style="font-size: 27px">Mensaje para ti:</span> <br><span><%=informes.getMensaje_informe()%></span></p>
                        <br/>
                        <p style="font-weight: 500;font-size: 22px"><span class="color-azul font-weight-bold" style="font-size: 27px">Mensaje sobre el estado la mascota</span> <br><span><%=informes.getDescripcion_informe()%></span></p>
                        <br/>
                        <br/>
                    </div>
                    <div class="col-md-6">
                        <p class="color-azul font-weight-bold" style="font-size: 27px;align-content: center;text-align: center">Evidencia fotográfica</p>
                        <br>
                        <center>
                            <img src="VerImgInforme?id=<%=informes.getId_informe()%>" alt="<%=informes.getNombreMascota()%>" width="50%" height="50%" style="border-radius: 20px"/>
                        </center>
                    </div>
                </div> 
            </div>
            ...
            <% if (informes.getRespuesta_admin_informe() == null) {%>       
            <form class="contact_bg" action="ControladorInformes" method="POST" onsubmit="formRtaInformeMascota(event)">
                <div class="col-md-12"> 
                    <div class="contacto_bg Gallery_text">  
                        <br>
                        <br>
                        <h2 style="font-weight: 700">Responder al adoptante</h2>                                        
                    </div>
                    <br><br>
                    <div class="row">
                        <div class="col-md-12 pt-2">
                            <textarea class="textarea" placeholder="Escribe aquí la respuesta a este informe para el adoptante" autocomplete="off" type="text" id="respuesta_informe" name="respuesta_informe"></textarea>
                        </div>
                        <input type="hidden" name="id_informe" value="<%=informes.getId_informe()%>">

                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
                            <button type="submit" name="accion" value="enviar_respuesta_informe" class="sendlogin" style="font-size:18px;font-weight: 700">Enviar respuesta</button>
                        </div>
                    </div>
                </div>
                <br>
            ...
            <div class="bg-dark rounded p-2 text-center">
                <h3 class="color-azul font-weight-bold"  style="font-size: 30px">Tú respuesta a este informe</h3>
                <p class="text-white" style="font-size: 25px; font-weight: 650"><%=informes.getRespuesta_admin_informe()%></p>
            </div>
            <%}
            %>
        </div>
