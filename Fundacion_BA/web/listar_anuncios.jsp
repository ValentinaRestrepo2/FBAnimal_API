<%-- 
    Document   : listar_anuncios
    Created on : 11/01/2022, 8:42:47 p. m.
    Author     : ZENBOOK
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <!-- site metas -->
        <title>Anuncios | Fundación Bello Animal</title>
        ...
        <div class="backgro_mh">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="heding">
                            <h2 style="font-weight: 700">Listado de anuncios</h2>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="card h-100 shadow-sm"> <img src="${pageContext.servletContext.contextPath}/imganuncio?id=<%=anu.getId_anuncio()%>" class="img-anuncios" alt="imagen del anuncio: <%=anu.getNombre_anuncio()%>">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex justify-content-center">
                                                    <form action="ControladorAnuncios" method="POST">
                                                        <div class="text-center my-4 mr-3">
                                                            <input type="hidden" name="id" value="<%=anu.getId_anuncio()%>">
                                                            <button class="btn btn-danger" type="submit" value="anuncioDelete" name="anuncio">
                                                    ...
                                                    <div class="text-center my-4"> 
                                                        <button class="btn btn-info" type="button" data-toggle="modal" data-target="#exampleModal2" onclick="cargarDatosAnuncios('<%=anu.getNombre_anuncio()%>', '<%=anu.getDescripcion()%>', '<%=anu.getCosto()%>', '<%=anu.getId_anuncio()%>')" id="btn_actualizar">
                            ...
                            <div class="modal-header">
                                <div class="input-group">
                                    <span class="input-group-text" id="basic-addon1">
                                        ...
                                        <h5 class="modal-title text-info font-weight-bold text-center" id="exampleModalLabel">&nbsp; &nbsp;  Agregar anuncio</h5>
                                    </span>
                                </div>                                <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color: white">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <form action="ControladorAnuncios" method="POST" enctype="multipart/form-data" onsubmit="formRegistrarAnuncio(event)">
                                    <div class="form-group">
                                        <label for="message-text" class="col-form-label font-weight-bold">Nombre para el anuncio<span class="text-danger">* </span> </label>
                                        <input type="text" class="form-control" id="recipient-name" name="nom_anuncio"autocomplete="off"/>
                                    </div>
                                    <div class="form-group">
                                        <label for="message-text" class="col-form-label font-weight-bold">Descripcion del anuncio <span class="text-danger">* </span> </label>
                                        <textarea class="form-control text-" name="desc_anuncio" autocomplete="off"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="message-text" class="col-form-label font-weight-bold">Costo<span class="text-danger">* </span> </label>
                                        <input type="number" class="form-control" name="costo_anuncio" autocomplete="off"/>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleFormControlFile1" class="col-form-label font-weight-bold">Foto<span class="text-danger">* </span> </label>
                                        <input type="file" class="form-control-file" name="foto_anuncio">
                                    </div>
                                    <br>
                                    <div class="row" style="margin-left: 15px">
                                        ...
                                        <button type="submit" class="btn btn-info alinear" name="anuncio" value="anuncioAdd"" >
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <div class="input-group">
                                    <span class="input-group-text" id="basic-addon1">
                                        ...
                                        <h5 class="modal-title text-info font-weight-bold text-center" id="exampleModalLabel">&nbsp; &nbsp;  Editar anuncio</h5>
                                    </span>
                                </div>                                <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color: white">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            ...
                            <div class="modal-body">
                                <form id="formulario_editar">
                                    <div class="form-group">
                                        <label for="message-text" class="col-form-label font-weight-bold">Nombre para el anuncio <span class="text-danger"> *</span> </label>
                                        <input type="text" class="form-control" id="recipient-name" name="edit_name_anuncio" autocomplete="off"/>
                                    </div>

                                    <div class="form-group">
                                        <label for="message-text" class="col-form-label font-weight-bold">Descripcion del anuncio<span class="text-danger"> *</span> </label>
                                        <textarea class="form-control text-" name="desc_edit_anuncio" autocomplete="off"></textarea>
                                    </div>

                                    <div class="form-group">
                                        <label for="message-text" class="col-form-label font-weight-bold">Costo<span class="text-danger"> *</span> </label>
                                        <input type="number" class="form-control" name="costo_edit_anuncio" autocomplete="off"/>
                                    </div>
                                    ...
                                    <div class="row" style="margin-left: 15px">
                                        ...
                                        <button type="button" class="btn btn-info alinear" id="actualizarAnuncio" >
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-square" viewBox="0 0 16 16">
                                            <path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"></path>
                                            <path d="M10.97 4.97a.75.75 0 0 1 1.071 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.235.235 0 0 1 .02-.022z"></path>
                                            </svg>
