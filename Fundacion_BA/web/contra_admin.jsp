<%-- 
    Document   : contra_admin
    Created on : 27-ene-2022, 11:28:17
    Author     : Andrés Marín
--%>
...
<html lang="en">
    <head>
        ...
        <!-- site metas -->
        <title>Fundación Bello Animal | Cambio de contraseña</title>
    ...
    <%
        ...
        if (request.getParameter("rspta") != null) {
            String colored = "font-weight-bold text-center text-danger mb-2";
            String colorgreen = "font-weight-bold text-center text-success mb-2";
            int r = Integer.parseInt(request.getParameter("rspta"));
            System.out.println(r + "cambiar_pass");
            if (r == 1) {
                rspta = "¡Felicidades, se ha cambiado tu contraseña correctamente!";
                coloractivo = colorgreen;
            } else if (r == 2) {
                rspta = "La contraseña actual no coincide con la registrada";
                coloractivo = colored;
            } else if (r == 3) {
                rspta = "La contraseña es igual a la que tienes actualmente";
                coloractivo = colored;
            } else {
        ...
        <div class="backgro_mh">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="heding">
                            <h2 style="font-weight: 700">Cambiar contraseña</h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">  
                        ...
                        <form class="contact_bg" action="ControladorIniciosesion" method="POST">
                            <h1 class="font-weight-bold" style="margin-top: 20px;font-weight: 700;font-size: 24px;color:white">Completa todos los campos</h1>
                            <div class="col-md-12">     
                                
                                <div class="col-md-12">
                                    <input class="contactus" placeholder="Escribe tu contraseña actual*" autocomplete="off" maxlength="30" min="2" type="password" name="passactual" id="name_registro" required>
                                </div>
                                <div class="col-md-12">
                                    <input class="contactus" placeholder="Escribe tu nueva contraseña*" autocomplete="off" maxlength="30" min="2" type="password" name="pass" id="name_registro" required>
                                </div>
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
                                    ...
                                    <button type="submit" name="accion" value="ActualizarContraAdmin" class="sendlogin" style="font-size:18px;font-weight: 700">Actualizar</button>
                                </div>
                            </div>
                        </form>
                    </div>
